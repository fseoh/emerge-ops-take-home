...
|---|---|---|---|
| **Coach calls have no dates.** Among the 3,000 students, 0 of the 1,423 with no calls got past lesson 4, and 418 of 717 lesson 1–4 stoppers had a call. | We can't tell if a call unlocks lesson 5, happens because of progress, or is required by process. Calls can't be treated as a lever until we know. | Call log with timestamp, student, coach, outcome. Confirm whether any call is required at a set lesson. | Coaching lead |
