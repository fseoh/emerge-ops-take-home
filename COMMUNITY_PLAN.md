...
|---|---|---|---|
| **Coach calls have no dates.** All 3,000 real students: 0 of the 1,423 with no calls got past lesson 4. Students with a first video by Jul 18 who stopped at lessons 1–4: 418 of 717 (58.3%) had a call. | We can't tell if a call unlocks lesson 5, happens because of progress, or is required by process. Calls can't be treated as a lever until we know. | Call log with timestamp, student, coach, outcome. Confirm whether any call is required at a set lesson. | Coaching lead |
